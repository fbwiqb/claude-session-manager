...
function parseSession(file) {
  ...
  let title = "", firstPrompt = "", msgCount = 0, model = "", lastTs = null;
  let data;
  ...
  return { session_id: sid, file_path: file, mtime, title, first_prompt: firstPrompt,
    msg_count: msgCount, size_bytes: size, model, last_activity: lastTs || mtime };
}
...
module.exports = { buildIndex, parseSession, projectOf };
