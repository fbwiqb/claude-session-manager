...
function codexTrashDir() {
  return path.join(configDir(), "csm-codex-trash");
}

module.exports = { configDir, projectsDir, indexCache, favPath, trashMeta, trashDir, sessionsDir, codexIndexCache, codexTrashDir };
